...
BuffMonitorEx.tBuffData = {
	["TargetBuff"] = BuffMonitorEx.tDefaultBuff,
	["TargetDebuff"] = BuffMonitorEx.tDefaultDebuff,
	["PlayerBuff"] = BuffMonitorEx.tDefaultBuff,
	["PlayerDebuff"] = BuffMonitorEx.tDefaultDebuff
}
